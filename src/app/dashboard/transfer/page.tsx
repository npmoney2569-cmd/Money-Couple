    ...
    <CrudPage
      ...
      fields={[
        ...
        { key: "date", label: "วันที่", type: "date", required: true },
        {
          ...
          optionsQuery: { table: "accounts_with_username", labelKey: "name", labelKeys: ["username"], labelSeparator: " · @", valueKey: "id", filter: { is_active: true }, filterByUserId: true, orderBy: "name", orderAscending: true },
        },
        {
          key: "to_account_id",
          label: "บัญชีปลายทาง",
